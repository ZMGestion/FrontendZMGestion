...
class VentaCreadaDialog extends StatefulWidget {
  final Ventas venta;

  const VentaCreadaDialog({
    Key key,
    this.venta
  }):super(key: key);

  @override
  _VentaCreadaDialogState createState() => _VentaCreadaDialogState();
}

class _VentaCreadaDialogState extends State<VentaCreadaDialog> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Text("La venta se ha creado con éxito. Seleccione lo que desee hacer."),
