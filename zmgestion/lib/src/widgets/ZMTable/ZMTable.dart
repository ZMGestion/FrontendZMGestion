    ...
    if(widget.paginate){
      setState(() {
        paginatedlistMethodConfiguration = new ListMethodConfiguration(
          ...
          authorizationHeader: widget.listMethodConfiguration.authorizationHeader,
          ...
          requestConfiguration: widget.listMethodConfiguration.requestConfiguration,
          actionsConfiguration: widget.listMethodConfiguration.actionsConfiguration,
          paginacion: pageInfo
        );
      });
    }
                    ...
                    children: [
                      ...
                      Visibility(
                        ...
                        child: PageInfoHandler(
                          key: Key(pageInfo.pagina.toString()+pageInfo.cantidadTotal.toString(),),
